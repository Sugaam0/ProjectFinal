...
.bg-custom{
	...
	background: linear-gradient(20deg, rgba(6,148,198,1) 0%, rgba(145,234,228,1) 100%);
}

</style>
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom py-3">
	<a class="navbar-brand" href="#"><i class="fa fa-book"
		aria-hidden="true"></i>Notehub</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mx-auto">
			...
			<li class="nav-item"><a class="nav-link" href="showNotes.jsp"><i
					class="fa fa-address-card" aria-hidden="true"></i> Show Notes</a></li>
		...
		<a href="" class="btn btn-light my-2 my-sm-0 mr-2" data-toggle="modal"
			...
			class="fa fa-user-circle-o" aria-hidden="true"> <%=user.getName()%></i></a>
